...
exports.processCervicalAssessment = void 0;
exports.processCervicalAssessmentCore = processCervicalAssessmentCore;
...
/* ----------------- callable ----------------- */
async function processCervicalAssessmentCore(data, _ctx) {
...
// -------------------------------
exports.processCervicalAssessment = functions
    .region("europe-west1")
    .https.onCall(async (data, ctx) => {
    return processCervicalAssessmentCore(data, ctx);
});
//# sourceMappingURL=processCervicalAssessment.js.map