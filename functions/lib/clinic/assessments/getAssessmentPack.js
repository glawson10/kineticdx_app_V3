...
exports.getAssessmentPack = getAssessmentPack;
const https_1 = require("firebase-functions/v2/https");
const admin = __importStar(require("firebase-admin"));
const authz_1 = require("../authz");
async function getAssessmentPack(req) {
    var _a, _b, _c, _d;
    if (!req.auth)
    ...
    if (!clinicId || !packId) {
        throw new https_1.HttpsError("invalid-argument", "clinicId and packId are required.");
    }
    const db = admin.firestore();
    const uid = req.auth.uid;
    await (0, authz_1.requireActiveMember)(db, clinicId, uid);
...
//# sourceMappingURL=getAssessmentPack.js.map