...
exports.buildLumbarSummary = buildLumbarSummary;
/**
 * Minimal label map for Lumbar v1.
 * Keep this in sync with lumbar_labels_v1.dart (patient-facing strings).
 */
const lumbarLabelsV1 = {
    // Red flags
    "lumbar.redflags.bladderBowelChange": "Have you noticed any new problems controlling your bladder or bowels?",
    "lumbar.redflags.saddleAnaesthesia": "Do you have any numbness around the groin/saddle area?",
    "lumbar.redflags.progressiveWeakness": "Is weakness in your leg/foot getting worse quickly?",
    "lumbar.redflags.feverUnwell": "Have you had fever or chills, or felt unusually unwell with this pain?",
    "lumbar.redflags.historyOfCancer": "Have you ever been treated for cancer?",
    "lumbar.redflags.recentTrauma": "Did this start after a significant fall, accident, or injury?",
    "lumbar.redflags.constantNightPain": "Is your pain constant and not eased by rest (including at night)?",
    // Pain
    ...
    // Narrative / other
    "lumbar.history.additionalInfo": "Anything else you want your clinician to know (cause, progression, treatments so far)?",
};
// -------------------------
// helpers
// -------------------------
const label = (k) => { var _a; return (_a = lumbarLabelsV1[k]) !== null && _a !== void 0 ? _a : k; };
function unwrapAnswerValue(x) {
...
function buildNarrative(answers) {
    ...
    const neuroBits = [];
    if (pins)
        neuroBits.push("pins/needles");
    if (numb)
        neuroBits.push("numbness");
...
// main builder
// -------------------------
function buildLumbarSummary(raw, // output of processLumbarAssessmentCore/processLumbarAssessment.ts
answers) {
    var _a, _b, _c, _d, _e;
    const triageLevel = (_b = (_a = raw === null || raw === void 0 ? void 0 : raw.triage) !== null && _a !== void 0 ? _a : raw === null || raw === void 0 ? void 0 : raw.triageLevel) !== null && _b !== void 0 ? _b : "green";
    const triageReasons = (_e = (_d = (_c = raw === null || raw === void 0 ? void 0 : raw.redFlagNotes) !== null && _c !== void 0 ? _c : raw === null || raw === void 0 ? void 0 : raw.notes) !== null && _d !== void 0 ? _d : raw === null || raw === void 0 ? void 0 : raw.triageReasons) !== null && _e !== void 0 ? _e : [];
    // Prefer detailedTop (it contains rationale + objectiveTests)
    const detailed = Array.isArray(raw === null || raw === void 0 ? void 0 : raw.detailedTop) ? raw.detailedTop : null;
    const topDifferentials = (detailed !== null && detailed !== void 0 ? detailed : [])
        .slice(0, 3)
        .map((d) => {
        var _a, _b, _c, _d, _e;
        return ({
    ...
    const objectiveTests = Array.isArray(raw === null || raw === void 0 ? void 0 : raw.clinicalToDo)
        ? raw.clinicalToDo
        : [];
