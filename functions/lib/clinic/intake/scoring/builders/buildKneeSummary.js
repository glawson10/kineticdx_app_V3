...
exports.buildKneeSummary = buildKneeSummary;
function buildKneeSummary(raw, answers) {
    ...
    return {
        ...
        narrative: (_k = (_j = raw.summaryNarrative) !== null && _j !== void 0 ? _j : raw.summary) !== null && _k !== void 0 ? _k : "Patient reports knee symptoms consistent with the above findings.",
        tables: {
...
//# sourceMappingURL=buildKneeSummary.js.map