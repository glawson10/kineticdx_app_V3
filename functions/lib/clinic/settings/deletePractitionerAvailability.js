...
exports.deletePractitionerAvailability = deletePractitionerAvailability;
...
async function deletePractitionerAvailability(request) {
    var _a, _b, _c, _d;
    ...
    const availabilityId = (0, validators_1.requireNonEmptyString)(data === null || data === void 0 ? void 0 : data.availabilityId, "availabilityId");
    ...
    if (!snap.exists) {
        throw new https_1.HttpsError("not-found", "Availability rule not found.");
    }
    const entityPath = `clinics/${clinicId}/practitioners/${practitionerId}/availability/${availabilityId}`;
    const docData = (_b = snap.data()) !== null && _b !== void 0 ? _b : {};
    await (0, audit_1.writeSettingsAuditEvent)(db, clinicId, "settings.availability.deleted", uid, entityPath, availabilityId, {
        deleted: true,
        locationId: (_c = docData.locationId) !== null && _c !== void 0 ? _c : null,
        startDate: (_d = docData.startDate) !== null && _d !== void 0 ? _d : null,
    });
    await ref.delete();
    await (0, mirrorPractitionerAvailabilityToLegacy_1.mirrorPractitionerAvailabilityToLegacy)(clinicId, practitionerId);
    return { ok: true };
}
//# sourceMappingURL=deletePractitionerAvailability.js.map