...
exports.buildElbowSummary = buildElbowSummary;
function buildElbowSummary(raw, // output of processElbowAssessment.ts
answers) {
    ...
    return {
        ...
        narrative: (_k = (_j = raw.summaryNarrative) !== null && _j !== void 0 ? _j : raw.summary) !== null && _k !== void 0 ? _k : "Patient reports elbow symptoms consistent with the above findings.",
        tables: {
