...
function buildKneeLegacyAnswers(answers) {
    ...
    const mapOnsetToScorer = (onsetId) => {
    ...
    const mapPainLocToScorer = (locId) => {
    ...
    return [
        ...
        single("K_rf_highEnergyTrauma", yesNo(v("knee.redflags.highEnergyTrauma"))),
        /**
         ...
         */
        single("K_rf_hotRedFeverish", yesNo(v("knee.redflags.hotSwollenJoint"))),
        ...
        multi("K_painTriggers", stripMany(v("knee.function.aggravators"), "aggs.")),
        // Instability / giving way
        // canonical: knee.symptoms.givingWay → scorer: K_currentInstability
        single("K_currentInstability", yesNo(v("knee.symptoms.givingWay"))),
        ...
        single("K_rf_unableWeightBear", yesNo(v("knee.redflags.unableToWeightBear"))),
        single("K_rf_lockedKnee", yesNo(v("knee.redflags.lockedKnee"))),
        single("K_rf_traumaHighEnergy", yesNo(v("knee.redflags.highEnergyTrauma"))),
        single("K_rf_hotSwollen", yesNo(v("knee.redflags.hotSwollenJoint"))),
        single("K_rf_historyCancer", yesNo(v("knee.redflags.historyOfCancer"))),
