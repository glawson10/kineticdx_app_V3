...
exports.generateIntakeSummaryFn = (0, https_1.onCall)({ region: "europe-west3" }, async (req) => {
    ...
    if (!clinicId || !intakeSessionId) {
        throw new https_1.HttpsError("invalid-argument", "clinicId and intakeSessionId are required", {
            clinicId,
            intakeSessionId,
        });
    }
    ...
    switch (flowId) {
        case "ankle": {
            ...
            const rawResult = (0, processAnkleAssessment_1.processAnkleAssessmentCore)(legacyAnswers);
            summary = (0, buildAnkleSummary_1.buildAnkleSummary)(rawResult, answers);
            break;
        }
        case "cervical": {
