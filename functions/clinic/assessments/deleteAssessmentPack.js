...
exports.deleteAssessmentPack = deleteAssessmentPack;
const https_1 = require("firebase-functions/v2/https");
const admin = __importStar(require("firebase-admin"));
const authz_1 = require("../authz");
const audit_1 = require("../audit/audit");
const paths_1 = require("../paths");
async function deleteAssessmentPack(req) {
    var _a, _b, _c, _d;
    if (!req.auth)
    ...
    if (!clinicId || !packId) {
        throw new https_1.HttpsError("invalid-argument", "clinicId, packId required.");
    }
...
//# sourceMappingURL=deleteAssessmentPack.js.map