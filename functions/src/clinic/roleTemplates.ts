...
function normalize(p: PermissionMap): PermissionMap {
  const out: PermissionMap = {};
  for (const k of Object.keys(p)) out[k] = p[k] === true;
  return out;
}
...
export function ownerRolePermissions(): PermissionMap {
  return normalize({
    "settings.read": true,
    "settings.write": true,
...
export function managerRolePermissions(): PermissionMap {
  return normalize({
    "settings.read": true,
    "settings.write": true,
...
export function clinicianRolePermissions(): PermissionMap {
  return normalize({
    "settings.read": true,
...
export function adminStaffRolePermissions(): PermissionMap {
  return normalize({
    "settings.read": true,
...
export function viewerRolePermissions(): PermissionMap {
  return normalize({
    "settings.read": true,
